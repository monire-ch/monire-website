...
const CaseStudyTowarowa = () => {
  ...
  const tools = ['TYPESCRIPT', 'TAILWIND', 'FIGMA', 'NETLIFY'];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)] gap-10 lg:gap-14 mb-16">
            ...
            <ScrollReveal>
              <div className="rounded-xl overflow-hidden border border-border bg-card h-[560px] md:h-[720px] overflow-y-auto">
                <img
                  src={towarowa}
                  alt="Towarowa 41 website preview"
            ...
            <div>
              <ScrollReveal>
                <div>
                  {[
                    { label: t('caseStudy.meta.client'), value: 'Towarowa' },
                    { label: t('caseStudy.meta.date'), value: 'October 2025' },
                  ].map((row, i) => (
