    ...
    <section id="services" className="py-20 md:py-28 px-6">
      <div className="max-w-5xl mx-auto">
        <ScrollReveal className="text-center mb-16">
          <span className="eyebrow-pill eyebrow-pill-light mb-3">{t("services.eyebrow")}</span>
          <h2 className="font-body text-3xl md:text-4xl text-main-teal">{t("services.title")}</h2>
        </ScrollReveal>
              ...
              <div className="dark-teal-surface rounded-xl overflow-hidden">
                <div className="p-8 md:p-10 flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div className={visuals[i] ? "md:w-2/3" : "w-full"}>
                    <span className="text-gold-text text-xs tracking-widest uppercase font-body mb-2 block">
                      {s.badge}
                    </span>
